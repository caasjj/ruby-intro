...
class AboutToStr < EdgeCase::Koan
  ...
  def test_normally_objects_cannot_be_used_where_strings_are_expected
    assert_raise(TypeError) do
      File.exist?(CanNotBeTreatedAsString.new)  # WH: Confused as to why .to_s "non-string-like" doesn't work!!
    end                                         #     hmmm .. because to_str is needed to make this a real String
  end
