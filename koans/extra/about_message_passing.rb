...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_methods_can_be_invoked_more_dynamically
    ...
    assert mc.send("CAUGHT?".to_sym.downcase )      # What would you need to do to the string?
  end                                               
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # THINK ABOUT IT:
    # see http://stackoverflow.com/questions/4658269/ruby-send-vs-send
    # Why does Ruby provide both send and __send__ ?  # WH: Why?? 
  end
