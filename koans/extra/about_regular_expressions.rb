...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # THINK ABOUT IT:
    #
    # When would * fail to match?  WH: hmmm ... not really clear on this!
  end
  ...
  def test_slash_d_is_a_shortcut_for_a_digit_character_class
    assert_equal "42", "the number is 42"[/[0123456789]+/]    # WH: What the H is this syntax????
    assert_equal "42", "the number is 42"[/\d+/]
  end

  def test_character_classes_can_include_ranges
    assert_equal "42", "the number is 42"[/[0-9]+/]    # WH: and this too...
  end
