...
class AboutIteration < EdgeCase::Koan
  ...
  def test_each_is_a_method_on_arrays
    ...
    assert_equal true, [].methods.include?(:each)  # WH: in 2.0, this is converted to a symbol anyway .. see as_name above
  end
  ...
  def test_inject_will_blow_your_mind
    ...
    # Extra Credit:
    # Describe in your own words what inject does.  # WH: It's _.reduce.  Repeatedly applies the block with 
  end                                               #     using the injected value as initial condition
  ...
  #
  #   file = File.open(filename)           # WH: This makes it difficult to alter the code to operate on the file
  #   # code to read 'file'                #     With the previous construct, we can just pass a different block/closure
  #
